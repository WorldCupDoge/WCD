...
contract WCD is ERC20, Ownable {
    ...
    constructor () ERC20("World Cup Doge", "WCD") 
    {   
        address router;
        if (block.chainid == 56) {
        ...
        treasuryWallet = 0x67fE80f57E58D0C25ff72e557Be8de9FB3403A86;

        maxWalletLimitEnabled = true;
        maxWalletAmount       = 20_000_000 * (10 ** decimals()); // 2%

        maxTransactionLimitEnabled = true;
        maxTransactionAmountBuy    = 10_000_000 * (10 ** decimals()); // 1%
        maxTransactionAmountSell   = 10_000_000 * (10 ** decimals()); // 1%
    ...
    function excludePresaleRouter(address account) external onlyOwner{
    ...
    function setSwapEnabled(bool _enabled) external onlyOwner{
        require(swapEnabled != _enabled, "Tax swap already at this state");
    ...
    function _transfer(address from,address to,uint256 amount) internal  override {
        ...
        if (canSwap &&
            ...
            if (treasuryShare > 0) {
                ...
                swapAndSendMarketing(treasuryTokens);
            }          
